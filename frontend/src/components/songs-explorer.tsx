...
export function SongsExplorer() {
  ...
  return <main className="page-enter mx-auto max-w-7xl px-5 pb-8 pt-10 lg:px-8 lg:pt-14">
    <header className="border-2 border-foreground bg-surface-berry p-6 text-surface-berry-foreground shadow-[4px_4px_0_var(--section-ink)] sm:p-8"><h1 className="font-heading text-4xl font-bold tracking-tight sm:text-[44px]">Songs</h1><p className="mt-2 max-w-2xl text-surface-berry-foreground/80">Find songs that won on music shows and see the artists behind them.</p></header>
